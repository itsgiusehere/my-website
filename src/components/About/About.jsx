      ...
      <div className="section-wrapper about-outer">
        ...
        <div ref={bioRef} className="about-bio fade-up">
          ...
          <div className="about-bio-text">
            <p className="about-lead">For over 15 years leading design and innovation efforts across logistics, fintech, hardware, music software, manufacturing. Each new domain is the part that excites me most. Mapping concepts, finding the first principles underneath, crafting to understand and to make that understanding shared.</p>
